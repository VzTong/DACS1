// Play video, Chạy cái video slider trailer
const eles = document.querySelectorAll('.item-video');
eles.forEach(item => {
...
$(function () {
    ...
    //==js for login, sign up, avtchange, watch trailer
    ...
    //pop up for avt form
    avtLink.on('click', function (event) {
        event.preventDefault();
        avtct.parents(overlay).addClass("openform");
        $(document).on('click', function (e) {
            var target = $(e.target);
            if ($(target).hasClass("overlay")) {
                $(target).find(avtct).each(function () {
                    $(this).removeClass("openform");
                });
                setTimeout(function () {
                    $(target).removeClass("openform");
...
$(document).ready(function () {
    var item_ep = $("a.check").text();
    console
        .log(item_ep)
    $(".number-ep").html(item_ep);
    $('.thumber a').on('click',
        function () {
            var video = document.getElementById('player');

            video.pause();
            $('#src-video').attr('src', $(this).attr('data-defaultsize'));
            $('#src-video').attr('title', $(this).attr('title'));
            $('#src-video').attr('alt', $(this).attr('alt'));
    ...
    $('.thumber a').click(ev => {
        ...
        $(".thumber a").removeClass('check');

        $(ev.currentTarget).addClass("check");
        var item_ep = $("a.check").text();
        console
            .log(item_ep)
        $(".number-ep").html(item_ep);
