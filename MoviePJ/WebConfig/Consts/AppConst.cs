...
namespace MoviePJ.WebConfig.Consts
{
	public class AppConst
	{
		...
		public const string APP_NAME = "Movie PJ";
		...
		// id role khách hàng
		public const short ROLE_CUSTOMER_ID = 2;

		// id role Admin
		public const short ROLE_ADMINISTRATOR_ID = 1;

		// Name Status In progress
		public const string STATUS_IN_PROGRESS = "In progress";

		// Name Status Finished
		public const string STATUS_FINIDHED = "Finished";
	}
}
